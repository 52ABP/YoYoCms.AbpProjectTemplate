namespace YoYoCms.AbpProjectTemplate.Migrations
{
    ...
    public partial class Change_Table_Name : DbMigration
    {
        public override void Up()
        {
            ...
            RenameTable(name: "dbo.AppChatMessages", newName: "ChatMessages");
            ...
            MoveTable(name: "dbo.ChatMessages", newSchema: "ABP");
            MoveTable(name: "dbo.Features", newSchema: "ABP");
            MoveTable(name: "dbo.Editions", newSchema: "ABP");
            MoveTable(name: "dbo.AppFriendships", newSchema: "ABP");
        ...
        public override void Down()
        {
            ...
            MoveTable(name: "ABP.AppFriendships", newSchema: "dbo");
            MoveTable(name: "ABP.Editions", newSchema: "dbo");
            MoveTable(name: "ABP.Features", newSchema: "dbo");
            MoveTable(name: "ABP.ChatMessages", newSchema: "dbo");
            ...
            RenameTable(name: "dbo.ChatMessages", newName: "AppChatMessages");
