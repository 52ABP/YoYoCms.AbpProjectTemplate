...
using YoYoCms.AbpProjectTemplate.Common;
using YoYoCms.AbpProjectTemplate.Editions;
using YoYoCms.AbpProjectTemplate.MultiTenancy;
using YoYoCms.AbpProjectTemplate.Web.Areas.Mpa.Models.Tenants;
...
namespace YoYoCms.AbpProjectTemplate.Web.Areas.Mpa.Controllers
{
    ...
    public class TenantsController : AbpProjectTemplateControllerBase
    {
